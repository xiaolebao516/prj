...
HD_PWD='D:/prj/7100/test_block/vivado/test_block.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PreProcess_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PreProcess_Top.tcl
