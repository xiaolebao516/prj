...
HD_PWD='C:/Study/7100_AD9670/7100_AD9670.runs/design_1_idelay_ctrl_wrapper_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_idelay_ctrl_wrapper_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_idelay_ctrl_wrapper_0_0.tcl
